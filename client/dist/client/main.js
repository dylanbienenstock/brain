...
var TaskListComponent = /** @class */ (function () {
    function TaskListComponent(httpService, stringUtilService, screenService, navbarService) {
        ...
        this.listUpdateTimeouts = [];
        this.taskUpdateTimeouts = [];
    }
    ...
    TaskListComponent.prototype.onTaskListDetailsModified = function (listIndex) {
        var _this = this;
        this.setNavbarExtensions();
        var listId = this.taskLists[listIndex]._id;
    ...
    TaskListComponent.prototype.onTaskDetailsModified = function (index) {
        var _this = this;
        this.setNavbarExtensions();
        var listId = this.curTaskListId;
        var task = __assign({}, this.curTaskList.tasks[index]);
        var taskId = task._id;
    ...
    TaskListComponent.prototype.parseDate = function (dateStr) {
        ...
        var date = (function () {
            var _loop_1 = function (regexName) {
                ...
                var dateObj = (function createDate() {
                    switch (regexName) {
